...
import com.education.android.criminalintent.database.CrimeDatabase
import com.education.android.criminalintent.database.migration_1_2
...
class CrimeRepository private constructor(context: Context) {
    ...
    companion object {
        ...
        fun get(): CrimeRepository {
            return INSTANCE ?: throw IllegalStateException("CrimeReposiory must be initialized")
        }
    }
}